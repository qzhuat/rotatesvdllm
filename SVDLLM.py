...
if __name__ == '__main__':
    ...
    parser.add_argument('--hf-token', type=str, help='Hugging Face authentication token',default="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")
    ...
    if args.step == 1:
        ...
        if not pathlib.Path.exists(profiling_mat_dir): 
            ...
            if args.save_path is not None:
                ...
                torch.save(profiling_mat, profiling_mat_dir)
        else:
